...
function Header() {
  return (
    <div className='w-full h-14 select-none bg-black text-white dark:bg-slate md:relative'>
      <div>
            <details className="w-full flex md:hidden h-8 bg-black open:w-full fixed md:relative z-10" open>
